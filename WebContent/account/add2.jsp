...
<jsp:param name="lo" value=""/>
		...
		<div id="contents"><!--내용-->
			...
			<ul class="basic_list">
				...
				<li><span>&#47; 월 납입금</span><input type="text" class="wr_account" name="payment"/></li>
				<li><span>&#47; 납입기간</span><input type="radio" name="years" value="1" checked />1년 <input type="radio" value="2" name="years" />2년 <input type="radio" value="3" name="years" />3년</li>
