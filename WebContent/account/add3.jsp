...
<jsp:param name="lo" value=""/>
		...
		<form id="form" action="${pageContext.request.contextPath}/account/add1Action.action" method="post">
			...
			<ul class="basic_list">
				...
				<li><span>&#47; 대출금액</span><input type="text" class="wr_account" name="balance"/></li>
				<li><span>&#47; 대출기간</span><input type="radio" name="years" value="1" checked />1년 <input type="radio" name="years" value="2"/>2년 <input type="radio" name="years" value="3"/>3년</li>
